exports.seed = async function (knex) {
  ...
  await knex('battle_pass_rewards').insert([
    ...
    { id: 5, level: 5, reward: JSON.stringify({ type: 'powerup', body: { powerup: 'joker', quantity: 10 } }) },
    ...
    { id: 10, level: 10, reward: JSON.stringify({ type: 'powerup', body: { powerup: 'lead', quantity: 7 } }) },
  ]);
};
