...
exports.down = function(knex) {
    return Promise.all([
        knex.schema.alterTable('heroes', function(table) {
            table.dropIndex('heroId', 'idx_heroes_heroId');
        }),
        knex.schema.alterTable('passives', function(table) {
            table.dropIndex('heroId', 'idx_passives_heroId');
        }),
        knex.schema.alterTable('dialogs', function(table) {
            table.dropIndex('heroId', 'idx_dialogs_heroId');
        }),
        knex.schema.alterTable('dialog_questions', function(table) {
            table.dropIndex('dialogId', 'idx_dialog_questions_dialogId');
        }),
        knex.schema.alterTable('player_passives', function(table) {
            table.dropIndex('playerId', 'idx_player_passives_playerId');
            table.dropIndex('heroId', 'idx_player_passives_heroId');
            table.dropIndex('passiveId', 'idx_player_passives_passiveId');
        })
    ]);
};