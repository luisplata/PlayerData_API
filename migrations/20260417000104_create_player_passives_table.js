exports.up = function(knex) {
    return knex.schema.createTable('player_passives', function(table) {
        ...
        table.string('passiveId').notNullable().references('passiveId').inTable('passives').onDelete('CASCADE');
